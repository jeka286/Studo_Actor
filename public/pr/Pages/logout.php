...
// Обработка выхода (ДОБАВЬТЕ ЭТУ ЧАСТЬ)
...
// Подключение к БД, чтобы достать данные пользователя (например, email)
$host = '127.0.1.30'; 
$user = 'root';      
$pass = '';          
$db_name = 'Golubko'; 
...
<head>
    ...
    <style>
        ...
        /* Стили для почты и кнопки выхода */
        ...
        .btn-card { align-self: flex-start; padding: 14px 35px; border-radius: 12px; border: none; color: white; font-weight: bold; cursor: pointer; transition: 0.3s; background: #4a6cf7; }
...
<header class="header">
    ...
    <div class="header-user">
        <div class="user-info">
            <!-- Выводим email из базы -->
            <span class="user-email"><?php echo htmlspecialchars($user_data['email']); ?></span>
            <!-- ИЗМЕНЕНО: ссылка теперь ведет на этот же файл с параметром logout -->
...
<main class="main-content">
    <div class="cards-grid">
        <div class="card card-circles">
            ...
            <button class="btn-card">Выбрать курс</button>
        </div>
        ...
        <div class="card card-pattern">
            ...
            <button class="btn-card">Пройти на кастинг</button>
        </div>
    </div>
</main>
